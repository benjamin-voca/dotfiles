...
Options:
  -o, --outputs <OUTPUTS>
      ...
      --resize <RESIZE>
          ...
          - crop: Resize the image to fill the whole screen, cropping out parts that
            don't fit
          - fit:  Resize the image to fit inside the screen, preserving the original
            aspect ratio

      --fill-color <FILL_COLOR>
          Which color to fill the padding with when output image does not fill
          screen
  ...
  -f, --filter <FILTER>
          ...
          best. Also note they are all slower than Nearest.
  ...
  -t, --transition-type <TRANSITION_TYPE>
          ...
          'none' is an alias to 'simple' that also sets the 'transition-step' to
          255. This has the effect of the transition finishing instantly
          
          'fade' is similar to 'simple' but the fade is controlled through the
      ...
      --transition-fps <TRANSITION_FPS>
          ...
          Also note this is **different** from the transition-step. That one
          controls by how much we approach the new image every frame.
          
          [env: SWWW_TRANSITION_FPS=]
          [default: 30]

      --transition-angle <TRANSITION_ANGLE>
          This is used for the 'wipe' and 'wave' transitions. It controls the angle
          of the wipe
          
          Note that the angle is in degrees, where '0' is right to left and '90' is
          top to bottom, and '270' bottom to top
          
          [env: SWWW_TRANSITION_ANGLE=]
          [default: 45]

      --transition-pos <TRANSITION_POS>
          This is only used for the 'grow','outer' transitions. It controls the
          center of circle (default is 'center').
          ...
          height 200,400 means 200 pixels from the left and 400 pixels from the
          bottom
      ...
      --transition-bezier <TRANSITION_BEZIER>
          bezier curve to use for the transition https://cubic-bezier.com is a good
          website to get these values from
      ...
      --transition-wave <TRANSITION_WAVE>
          currently only used for 'wave' transition to control the width and height
          of each wave
